...
class RemoveCartItem implements ToolInterface
{
    public function __construct(private CartService $cartService) {}

    public function getName(): string { return 'remove_cart_item'; }

    public function getDefinition(): array
    {
        return ['type' => 'function', 'function' => [
            'name' => $this->getName(),
            'description' => 'Remove a cart item by its 1-based visible position. Never supply Magento quote item ids.',
            'parameters' => [
                'type' => 'object',
                'properties' => [
    ...
    public function execute(array $arguments, array $context = []): array
    {
        ...
        return $this->cartService->removeItem($identity, $itemId, null, $cartId);
    }
}
