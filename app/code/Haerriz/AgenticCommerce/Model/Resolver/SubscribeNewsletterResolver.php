...
class SubscribeNewsletterResolver implements ResolverInterface
{
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null): array
    {
        ...
        $identity = $this->customerContext->identityForTool($context, null, 'subscribe_newsletter');
        return $this->idempotent->execute('subscribe_newsletter', $input, $identity, fn(): array => $this->newsletter->subscribe($identity));
    }
}
