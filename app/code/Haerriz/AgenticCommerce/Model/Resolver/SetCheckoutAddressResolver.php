...
class SetCheckoutAddressResolver implements ResolverInterface
{
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null): array
    {
        ...
        $identity = $this->customerContext->identityForTool($context, $input['client_id'] ?? null, 'set_checkout_address');
        return $this->idempotent->execute('set_checkout_address', $input, $identity, fn(): array =>
            $this->checkout->setAddress($identity, (string)($input['kind'] ?? ''), (array)($input['address'] ?? []), $input['cart_id'] ?? null)
        );
    }
}
